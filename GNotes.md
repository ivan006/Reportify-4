...
google: youtube laravel read from dropbox api
...
yotuuhbe: dropbox api v2 sync
https://www.youtube.com/watch?v=AzCQrjWQJs4
google: php sync to server dropbox
https://powerusers.microsoft.com/t5/Building-Flows/Sync-a-Dropbox-folder-to-ftp-webserver/td-p/89132
google: dropbox connector and the FTP
google: dropbox server integration php library
google: using dropbox as laravel storage
google: dropbox webhook trigger upload file
